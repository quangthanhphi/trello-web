...
export const mapOrder = (originalArray, orderArray, key) => {
  ...
  return [...originalArray].sort((a, b) => orderArray.indexOf(a[key]) - orderArray.indexOf(b[key])) // [...originalArray] - Tạo bản sao mới của mảng

  // const clonedArray = [...originalArray]
  // const orderedArray = clonedArray.sort((a, b) => {
  //   return orderArray.indexOf(a[key]) - orderArray.indexOf(b[key]) //compare function
  // })
